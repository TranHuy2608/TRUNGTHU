...
const wishList = [
  {
    text: "Chúc Ngân và gia đình một mùa Trung Thu đoàn viên, tràn ngập niềm vui và hạnh phúc!",
    img: "./assets/1.jpg",
  },
  {
    text: "Cầu chúc cho mọi nguyện ước của cậu đêm nay Ngânsẽ trở thành hiện thực.",
    img: "./assets/2.jpg",
  },
  {
    text: "Trăng tròn ấm áp, chúc tình Ngân và tình yêu của chúng ta mãi bền chặt.",
    img: "./assets/3.jpg",
  },
  {
    text: "Chúc Ngân luôn giữ được tâm hồn trong trẻo, yêu đời như ánh trăng rằm.",
    img: "./assets/1.jpg",
  },
  {
  ...
  {
    text: "Chúc riêng Ngân một đêm trăng thật lãng mạn và ngọt ngào.",
    img: "./assets/3.jpg",
  },
  {
